    ...
    <?php foreach ($sectionOrder as $section): ?>
      <?php if (isset($organized_workflow_steps[$section]) && $organized_workflow_steps[$section]->count() > 0): ?>
          ...
          <tr>
              ...
              <?php if (isset($step['approvers']) && count($step['approvers']) > 0): ?>
                <?php foreach ($step['approvers'] as $approver): ?>
                            <?php renderApproverInfo($approver, $role, $section, $specialMemo); ?>
                        <?php endforeach; ?>
                    <?php else: ?>
        ...
        <?php endif; ?>
              ...
              <?php if (isset($step['approvers']) && count($step['approvers']) > 0): ?>
                <?php foreach ($step['approvers'] as $approver): ?>
                            <?php renderSignature($approver, $order, $approval_trails, $specialMemo); ?>
          <?php endforeach; ?>
        <?php endif; ?>
      </td>
                <?php if ($section === $sectionOrder[0] && $index === 0): // Only output the Date/FileNo cell once ?>
                  ...
                  <div>
                    <br><br>
                                ...
                                <span style="word-break: break-all; font-weight: bold;"><?php echo htmlspecialchars($special_memo_reference); ?></span>
          </div>
        </div>
      </td>
            <?php endif; ?>
  ...
  <div>
    ...
    <div class="topbar">
      <div class="meta" aria-label="Memo metadata">
        <span class="memo-id"><?php echo $special_memo_reference; ?></span><br/>
    ...
    <table class="budget-table" role="table" aria-label="Budget and Certification">
      ...
      <tr>
        ...
        <td>
            ...
            <?php renderBudgetSignature($approvalOrder5, $specialMemo); ?>
        </td>
      </tr>
      <tr>
    ...
    <table class="sig-table" role="table" aria-label="Approvals">
      <tr>
        ...
        <td style="border-left:1px solid #d8dee9; border-top:none; border-right:none; border-bottom:none;">
          <span class="fill">
            <?php renderBudgetSignature($approvalOrder1, $specialMemo); ?>
          </span>
        </td>
      </tr>
      <tr>
        ...
        <td style="border-left:1px solid #d8dee9; border-top:none; border-right:none; border-bottom:none;">
          <span class="fill">
            <?php renderBudgetSignature($approvalOrder6, $specialMemo); ?>
          </span>
        </td>
      </tr>
      <tr>
        ...
        <td style="border-left:1px solid #d8dee9; border-top:none; border-right:none; border-bottom:none;">
          <span class="fill">
            <?php renderBudgetSignature($approvalOrder8, $specialMemo); ?>
          </span>
        </td>
      </tr>
    </table>
