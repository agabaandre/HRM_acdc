...
<head>
    ...
    <title>ARF Notification - Africa CDC</title>
    <style>
        body {
            ...
            <div class="details">
                ...
                <div class="details-grid">
                    <div class="detail-item">
                        <span class="detail-label">ARF Number:</span>
                        <span class="detail-value">#{{ $resource->arf_number ?? 'N/A' }}</span>
                    </div>
                    <div class="detail-item">
