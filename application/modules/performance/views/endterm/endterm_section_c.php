...
<div class="mb-3">
  ...
  <textarea name="endterm_achievements" id="endterm_achievements" class="form-control endterm-achievements-field ppa-summernote" rows="4" <?= $endreadonly ?>  <?php if(!$isSupervisor){echo 'readonly';}?>><?= $ppa->endterm_achievements ?? '' ?></textarea>
...
<div class="mb-3">
  ...
  <textarea name="endterm_non_achievements" id="endterm_non_achievements" class="form-control ppa-summernote" rows="4" <?= $endreadonly ?> <?php if(!$isSupervisor){echo 'readonly';}?>><?= $ppa->endterm_non_achievements ?? '' ?></textarea>
</div>
