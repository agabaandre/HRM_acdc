					...
					<tbody>
						...
						foreach ($grades->result() as $grade) : ?>
							...
							<tr>
								...
								<td><button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#update_grades<?php echo $grade->grade_id; ?>" href="#"><i class="fa fa-edit"></i>Edit</button>
								</td>
							</tr>
