    ...
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
                ...
                <tbody>
                        ...
                        <tr>
                                            <td>{{ $count++ }}</td>
                            <td style="max-width: 200px; width: 200px; word-wrap: break-word; overflow-wrap: break-word;">
                                <div class="fw-bold text-primary text-break" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.3;">{{ $request->document_number ?? 'N/A' }}</div>
                            </td>
                            <td style="max-width: 350px; width: 350px; word-wrap: break-word; overflow-wrap: break-word;">
                                <div class="fw-bold text-primary text-break" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.3;">{{ to_sentence_case($request->title ?? 'N/A') }}</div>
                            </td>
                            <td style="max-width: 120px; width: 120px; word-wrap: break-word; overflow-wrap: break-word;">
                                <div class="text-break" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.3;">{{ $request->responsiblePerson ? ($request->responsiblePerson->fname . ' ' . $request->responsiblePerson->lname) : 'N/A' }}</div>
                            </td>
                            <td style="max-width: 120px; width: 120px; word-wrap: break-word; overflow-wrap: break-word;">
                                <div class="text-break" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.3;">{{ $request->division->division_name ?? 'N/A' }}</div>
                            </td>
                            <td>{{ $request->request_date ? \Carbon\Carbon::parse($request->request_date)->format('M d, Y') : 'N/A' }}</td>
                            <td style="max-width: 180px; width: 180px; word-wrap: break-word; overflow-wrap: break-word;">
