...
MODULE="apm"
SRC="${STAFF_APM_LEGACY_ROOT:-${REPO_ROOT}/modules/apm/storage/app/public}"
...
log "Set in modules/apm/.env:"
log "  STAFF_DATA_ROOT=${STAFF_DATA_ROOT}"
log "  STAFF_APM_FILES_ROOT=${DEST}"
log "Then: cd ${REPO_ROOT}/modules/apm && php artisan storage:link"
