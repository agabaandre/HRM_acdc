...
<head>
    <meta charset="utf-8">
    <title>All Staff PPA Entries</title>
    <style>
    ...
    foreach ($plans as $plan): ?>
        ...
        <tr>
            <td colspan="6">
                ...
                <p><strong>Recommended:</strong> <?= $plan['training_recommended'] ?></p>
                <?php if (!empty($plan['training_contributions'])): ?>
                    <p><strong>Contribution:</strong> <?= $plan['training_contributions'] ?></p>
                <?php endif ?>
                <?php if (!empty($plan['recommended_trainings_details'])): ?>
                    <p><strong>Details:</strong> <?= $plan['recommended_trainings_details'] ?></p>
                <?php endif ?>
            </td>
        </tr>
    <?php endforeach ?>
