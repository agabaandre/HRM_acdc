...
/**
 * Mirrors helpdesk/backend/index.php so requests landing on staff-portal/backend/
 * (DirectoryIndex) are routed to Laravel's public/index.php without "/public/" in the URL.
 */
...
// Strip any base prefix up to and including "staff-portal/backend/" so we can
// look files up inside public/ by their relative path.
$relative = $uri;
$marker = 'staff-portal/backend/';
