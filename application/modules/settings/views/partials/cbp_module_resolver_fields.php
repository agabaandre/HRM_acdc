...
<div class="col-12 cbp-resolver-panel border rounded p-3 mb-2" data-cbp-for="codeigniter staff_app_token external_microservice">
  ...
  <div class="form-text small">
    ...
    <span class="cbp-hint d-none" data-cbp-hint="external_microservice">Optional <strong>single full URL</strong> for every environment, or leave empty and use development / production URLs for the external system below.</span>
  </div>
</div>
...
<div class="col-12 cbp-resolver-panel border rounded p-3 mb-2" data-cbp-for="finance_host external_microservice">
  ...
  <p class="small text-muted mb-2 cbp-env-ext d-none">Same host detection: local Staff portal → development system URL; production Staff → production system URL.</p>
  <div class="row g-2">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <label class="form-label mb-0 cbp-lbl-prod-ext d-none">External system — production URL</label>
      ...
      <div class="form-text small cbp-help-ext d-none">Full <code>https://</code> URL recommended for production external systems.</div>
    </div>
  </div>
</div>
...
<div class="col-12 cbp-resolver-panel" data-cbp-for="codeigniter staff_app_token finance_host external_microservice">
  ...
  <div class="form-text small text-muted">Adds <code>?token=…</code> or <code>&amp;token=…</code> with the same payload as APM/Finance. The target service must validate it. For <strong>Staff portal path</strong>, leave unchecked unless the route expects a token. External systems must implement verification on their side.</div>
</div>
