...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared("
            INSERT INTO `divisions` (`id`, `division_name`, `division_head`, `focal_person`, `admin_assistant`, `finance_officer`, `directorate_id`, `head_oic_id`, `head_oic_start_date`, `head_oic_end_date`, `director_id`, `director_oic_id`, `director_oic_start_date`, `director_oic_end_date`, `category`) VALUES
