              ...
              <div class="modal fade" id="delete_duty<?php echo $duty->duty_station_id; ?>" tabindex="-1" aria-labelledby="add_item_label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="add_item_label">Delete Duty Station</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <center>
                            <p><?php echo $duty->duty_station_name; ?></p>
                          </center>
                        </div>
