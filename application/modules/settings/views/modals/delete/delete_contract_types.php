              ...
              <div class="modal fade" id="delete_contract_type<?php echo $contract->contract_type_id; ?>" tabindex="-1" aria-labelledby="add_item_label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="add_item_label">Delete Contracting Institution</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <input type="hidden" name="redirect" value="types">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <center>
                            <p><?php echo $contract->contract_type; ?></p>
                          </center>
                        </div>
