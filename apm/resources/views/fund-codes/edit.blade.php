...
<div class="card shadow-sm">
    <div class="card-header bg-warning text-dark">
        <h5 class="mb-0"><i class="bx bx-edit me-2"></i>Edit Fund Code</h5>
    </div>
    <div class="card-body p-4">
        <form action="{{ route('fund-codes.update', $fundCode) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    <div class="form-group position-relative">
                        ...
                        <select name="fund_type_id" id="fund_type_id" class="form-select form-select-lg @error('fund_type_id') is-invalid @enderror" required>
            ...
            <div class="mb-4">
                <div class="form-group position-relative">
                    ...
                    <textarea 
                        ...
                        name="description" 
                        rows="4" 
                        placeholder="Enter detailed description">{{ old('description', $fundCode->description) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <small class="text-muted d-block">Inactive fund codes will not be available for selection in other modules</small>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center border-top pt-4 mt-4">
                ...
                <button type="submit" class="btn btn-warning btn-lg px-5 shadow-sm">
                    <i class="bx bx-save me-2"></i> Update Fund Code
                </button>
            </div>
        </form>
    </div>
