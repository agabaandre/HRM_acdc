#!/usr/bin/env bash
# Migrate staff-portal/backend/storage/app/public → /var/staffdata/{site-id}/staff-portal/
set -euo pipefail
source "$(dirname "$0")/_common.sh"

MODULE="staff-portal"
SRC="${STAFF_PORTAL_LEGACY_ROOT:-${REPO_ROOT}/modules/staff-portal/backend/storage/app/public}"
...
log "Set in modules/staff-portal/backend/.env:"
...
log "Then: cd ${REPO_ROOT}/modules/staff-portal/backend && php artisan storage:link"
