...
<div class="container-fluid py-4 px-4" id="dashboardContent">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h2 class="mb-1" style="color: #911C39; font-weight: 600;">
            <i class="fa fa-chart-line me-2"></i>PPA Performance Dashboard
          </h2>
          <p class="text-muted mb-0">Comprehensive analytics and insights for performance plan agreements</p>
        </div>
  ...
  <div class="row mb-4" id="dashboardFilters">
    ...
    <div class="col-md-2 d-flex align-items-end">
      <button class="btn w-100" style="background-color: #119A48; color: white;" onclick="loadPPADashboard()">
  ...
  <div class="row g-4">
      ...
      <div class="card shadow-sm rounded border-0 h-100">
        <div class="card-body p-4">
          <h5 class="card-title mb-4" style="color: #7A7A7A; font-weight: 600;">
            <i class="fa fa-file-contract me-2"></i>PPA Completion by Contract Type
          </h5>
    ...
    <div class="col-lg-6">
      <div class="card shadow-sm rounded border-0 h-100">
        <div class="card-body p-4">
          <h5 class="card-title mb-4" style="color: #001011; font-weight: 600;">
            <i class="fa fa-list-alt me-2"></i>Training Categories from PPA
          </h5>
      ...
      <div class="card shadow-sm rounded border-0">
        <div class="card-body p-4">
          <h5 class="card-title mb-4" style="color: #911C39; font-weight: 600;">
            <i class="fa fa-building me-2"></i>Submissions by Division
          </h5>
    ...
    <div class="col-lg-12">
      <div class="card shadow-sm rounded border-0">
        <div class="card-body p-4">
          <h5 class="card-title mb-4" style="color: #911C39; font-weight: 600;">
            <i class="fa fa-graduation-cap me-2"></i>Top 10 Training Skills Requested
          </h5>
      ...
      <div class="card shadow-sm rounded border-0">
        <div class="card-body p-4">
          <h5 class="card-title mb-4" style="color: #385CAD; font-weight: 600;">
            <i class="fa fa-chart-line me-2"></i>Submission Trend Over Time
          </h5>
