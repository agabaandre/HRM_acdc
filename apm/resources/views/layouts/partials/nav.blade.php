...
<div class="nav-container primary-menu">
    <nav class="navbar navbar-expand-xl w-100">
        <ul class="navbar-nav justify-content-start">
            ...
            @if (in_array(89, user_session('permissions', [])))
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ Request::is('fund-types*') || Request::is('fund-codes*') || Request::is('funders*') || Request::is('divisions*') || Request::is('directorates*') || Request::is('request-types*') || Request::is('jobs*') || Request::is('backups*') ? 'active' : '' }}"
                        href="#" data-bs-toggle="dropdown">
