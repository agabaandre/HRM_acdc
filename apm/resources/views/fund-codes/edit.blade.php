...
<div class="card shadow-sm border-0 mb-5">
    <div class="card-header bg-white border-bottom">
        <h5 class="mb-0 text-dark">
            <i class="bx bx-edit me-2"></i> Edit Fund Code: {{ $fundCode->code }}
        </h5>
    </div>
    <div class="card-body p-4">
        <form action="{{ route('fund-codes.update', $fundCode) }}" method="POST" id="editFundCodeForm">
            @csrf
            @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="funder_id" id="funder_id" class="form-select select2 border-success @error('funder_id') is-invalid @enderror" required>
                                ...
                                @foreach($funders as $funder)
                                    <option value="{{ $funder->id }}" {{ old('funder_id', $fundCode->funder_id) == $funder->id ? 'selected' : '' }}>
                                        {{ $funder->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="partner_id" id="partner_id" class="form-select select2 border-success @error('partner_id') is-invalid @enderror">
                                ...
                                @foreach($partners as $partner)
                                    <option value="{{ $partner->id }}" {{ old('partner_id', $fundCode->partner_id) == $partner->id ? 'selected' : '' }}>{{ $partner->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="year" id="year" class="form-select select2 border-success @error('year') is-invalid @enderror" required>
                                ...
                                @for($yearOption = date('Y'); $yearOption >= date('Y') - 5; $yearOption--)
                                    <option value="{{ $yearOption }}" {{ old('year', $fundCode->year) == $yearOption ? 'selected' : '' }}>{{ $yearOption }}</option>
                                @endfor
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="fund_type_id" id="fund_type_id" class="form-select select2 border-success @error('fund_type_id') is-invalid @enderror" required>
                                ...
                                @foreach($fundTypes as $fundType)
                                    <option value="{{ $fundType->id }}" {{ old('fund_type_id', $fundCode->fund_type_id) == $fundType->id ? 'selected' : '' }}>
                                        {{ $fundType->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="division_id" id="division_id" class="form-select select2 border-success @error('division_id') is-invalid @enderror">
                                ...
                                @foreach($divisions as $division)
                                    <option value="{{ $division->id }}" {{ old('division_id', $fundCode->division_id) == $division->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea class="form-control border-success @error('activity') is-invalid @enderror" 
                                      ...
                                      name="activity" 
                                      rows="3" 
                                      placeholder="Describe the activity">{{ old('activity', $fundCode->activity) }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="cost_centre" 
                                   name="cost_centre" 
                                   value="{{ old('cost_centre', $fundCode->cost_centre) }}" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="amert_code" 
                                   name="amert_code" 
                                   value="{{ old('amert_code', $fundCode->amert_code) }}" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="budget_balance" 
                                   name="budget_balance" 
                                   value="{{ old('budget_balance', $fundCode->budget_balance) }}" 
                                   placeholder="0.00">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('approved_budget', $fundCode->approved_budget) }}" 
                                   placeholder="0.00">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('uploaded_budget', $fundCode->uploaded_budget) }}" 
                                   placeholder="0.00">
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $fundCode->is_active) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-3 mt-5 pt-4 border-top">
                ...
                <button type="submit" class="btn btn-success px-4">
                    <i class="bx bx-save me-1"></i> Update Fund Code
                </button>
            </div>
        </form>
    </div>
