...
<head>
  <meta charset="UTF-8">
  <title>Endterm Review Update Notification</title>
  <style type="text/css">
    body {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <!-- Main Content -->
    <div class="content">
      <h1>Your Endterm Review Has Been Updated</h1>

      <p>Dear <strong><?= $name ?></strong>,</p>

      <p>
        We would like to inform you that your submitted <strong>Endterm Review</strong> for the period 
      ...
      <p>
        Please review the updated endterm to stay informed about your progress and development plan.
      </p>

      <p>
        <a href="<?= site_url('performance/endterm/endterm_review/' . $entry_id); ?>/<?= $staff_id ?>" class="btn">View Updated Endterm</a>
      </p>
