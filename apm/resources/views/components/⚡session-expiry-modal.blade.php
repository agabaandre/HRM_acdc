...
{
    // Session modals: rendered by Livewire, controlled by session-monitor.js (same DOM ids).
};
?>
...
#sessionExpiredModal .btn-primary { min-width: 140px; font-weight: 500; }
#sessionExpiryModal .btn-outline-secondary { min-width: 120px; font-weight: 500; }
#countdownTimer { font-size: 1.5rem; font-family: 'Courier New', monospace; }
