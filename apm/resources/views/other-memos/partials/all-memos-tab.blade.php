...
<div class="table-responsive">
    <table class="table table-hover mb-0">
        <thead class="table-primary">
            <tr>
                <th style="width: 5%;">#</th>
                <th style="width: 28%;">Title / type</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="text-wrap" style="max-width: 280px;">
                            ...
                            @endif
                            <div class="fw-bold text-primary">{{ Str::limit(data_get($memo->payload, 'title') ?: $memo->memo_type_name_snapshot, 70) }}</div>
                    ...
                    <td>
                        <div class="text-wrap" style="max-width: 120px;">
                            @if($memo->creator)
                                {{ Str::limit(trim(($memo->creator->title ? $memo->creator->title . ' ' : '') . $memo->creator->fname . ' ' . $memo->creator->lname), 22) }}
                            @else
                    ...
                    <td>
                        <div class="text-wrap" style="max-width: 120px;">
                            {{ Str::limit($memo->division->division_name ?? 'N/A', 18) }}
                        </div>
                    </td>
...
<div class="text-center py-4 text-muted">
    ...
    <small>Try adjusting filters or year.</small>
</div>
@endif
