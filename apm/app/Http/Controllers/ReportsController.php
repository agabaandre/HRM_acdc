    ...
    private function getMemoListRowsForType(string $documentType, Request $request): \Illuminate\Support\Collection
    {
        ...
        if ($documentType === DocumentCounter::TYPE_QUARTERLY_MATRIX || $documentType === DocumentCounter::TYPE_SINGLE_MEMO) {
            ...
            $q = Activity::query()
                ->select([
                    ...
                    $activitiesTable . '.approval_level',
                    $activitiesTable . '.next_approval_level',
                    ...
                    $matricesTable . '.approval_level as matrix_approval_level',
            ...
            foreach ($list as $a) {
                ...
                $rows->push((object) [
                    ...
                    'approval_level' => $a->approval_level ?? $a->matrix_approval_level ?? null,
                    'next_approval_level' => $a->next_approval_level ?? null,
        ...
        foreach ($q->get() as $m) {
            ...
            $rows->push((object) [
                ...
                'next_approval_level' => $m->next_approval_level ?? null,
