  ...
  <div>
    ...
    <div v-show="activeTab === 'software'" class="cbp-card software-gateway" role="tabpanel">
      ...
      <p class="gateway-copy">
        Information System requests use a dedicated form under HelpDesk Modules — including drafts, status tracking, HoD approval, and reviewer workflows.
      </p>
    ...
    <div v-show="activeTab === 'hosting'" class="cbp-card software-gateway" role="tabpanel">
      ...
      <p class="gateway-copy">
        Request cloud or on-premises hosting. Your Head of Division must approve before HelpDesk agents can process the request.
      </p>
