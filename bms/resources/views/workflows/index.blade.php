                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#deleteWorkflow{{ $workflow->id }}">Delete</button>

                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="deleteWorkflow{{ $workflow->id }}" tabindex="-1"
                                                    aria-labelledby="deleteWorkflowLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteWorkflowLabel">Confirm Delete
                                                                </h5>
