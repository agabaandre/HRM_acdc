...
# Laravel Supervisor Setup Script for macOS
# This script sets up both queue workers and scheduler through Supervisor

PROJECT_DIR="/opt/homebrew/var/www/staff/apm"
SUPERVISOR_DIR="/usr/local/etc/supervisor/conf.d"

echo "Setting up Laravel Supervisor configuration for macOS..."
...
sudo chown -R $CURRENT_USER:staff $PROJECT_DIR/storage/logs
sudo chmod -R 755 $PROJECT_DIR/storage/logs
