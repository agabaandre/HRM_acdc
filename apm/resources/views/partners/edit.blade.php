...
<div class="card shadow-sm">
    ...
    <div class="card-body p-4">
        <form action="{{ route('partners.update', $partner) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="name" class="form-label fw-semibold">Partner Name <span class="text-danger">*</span></label>
                <input type="text"
            ...
            <div class="d-flex justify-content-between align-items-center border-top pt-4 mt-4">
                <a wire:navigate href="{{ route('partners.index') }}" class="btn btn-outline-secondary px-4">
                    <i class="bx bx-arrow-back me-1"></i> Cancel
                </a>
                <button type="submit" class="btn btn-warning btn-lg px-5 shadow-sm">
                    <i class="bx bx-save me-2"></i> Update Partner
                </button>
            </div>
        </form>
    </div>
