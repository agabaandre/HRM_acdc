...
<script>
    $(function() {
        ...
        $('#fund_type').change(function(event) {
            ...
            // External source: hide Budget Code(s) and World Bank Activity Code
        ...
        // Get budget codes based on fund type and division (extramural: division + unbounded; intramural: same)
