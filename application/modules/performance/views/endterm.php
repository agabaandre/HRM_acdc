...
<style>
  #endtermApproverPreviewModal .preview-readonly-text { white-space: pre-wrap; word-break: break-word; min-height: 1.2em; }
</style>
<script>
(function () {
  function flattenPreviewToText(root) {
    ...
    root.querySelectorAll('.select2-container').forEach(function (el) { el.remove(); });
    root.querySelectorAll('select').forEach(function (el) { el.remove(); });
