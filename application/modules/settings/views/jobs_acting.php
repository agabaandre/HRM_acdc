					...
					<tbody>
						...
						foreach ($jobs_acting->result() as $acting) : ?>
							...
							<tr>
								...
								<td><button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#update_jobs_acting<?php echo $acting->job_acting_id; ?>" href="#"><i class="fa fa-edit"></i>Edit</button>
								</td>
							</tr>
