...
$query = $this->db->query("SELECT l.*, s.fname, s.lname, lt.leave_name 
            ...
            AND (l.supervisor_id = $staff_id OR l.staff_id = $staff_id OR l.supporting_staff = $staff_id OR l.division_head = $staff_id OR $staff_id IN(select user.auth_staff_id from user where role=20)) 
