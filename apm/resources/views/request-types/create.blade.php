...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="mb-0"><i class="bx bx-plus-circle me-2"></i>New Request Type</h5>
        </div>
            ...
            <form action="{{ route('request-types.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <div class="form-group position-relative">
                        ...
                        <input type="text" class="form-control form-control-lg @error('request_type') is-invalid @enderror"
                            id="request_type" name="request_type" value="{{ old('request_type') }}"
                            placeholder="Enter request type name" required>
                        <small class="text-muted mt-1 d-block">E.g., Travel Request, Meeting Request, Purchase
                            Request</small>
                        @error('request_type')
                ...
                <div class="mb-4">
                    <div class="form-group position-relative">
                        ...
                        <small class="text-muted mt-1 d-block">Provide a clear description of when this request type should
                            be used</small>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted d-block">Inactive request types will not be available for selection in
                        activities or memos</small>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center border-top pt-4 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg px-5 shadow-sm">
                        <i class="bx bx-save me-2"></i> Save Request Type
                    </button>
                </div>
            </form>
        </div>
