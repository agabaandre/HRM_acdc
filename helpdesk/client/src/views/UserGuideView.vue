...
const slides = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Helpdesk Modules & live screen', text: 'Use Helpdesk Modules → IT Assets / Licenses / Software requests when you have permission. Open /screen on a TV for queue stats (no personal data).' },
    ],
