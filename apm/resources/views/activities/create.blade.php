        ...
        <div class="card-body p-4">
            <form action="{{ route('matrices.activities.store', $matrix) }}" method="POST" id="activityForm">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <label for="fund_type" class="form-label fw-semibold">Fund Type <span
                                ...
                                <tr data-participant-id="{{ $member->id }}" class="d-none">
                                    ...
                                    <td>
                                        <input type="number" name="participant_days[{{ $member->id }}]"
                                            class="form-control participant-days" value="0" min="0">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="d-flex justify-content-end mt-4">
                    <div class="border p-4 rounded-3 shadow-sm bg-light">
                        <h5 class="mb-0">Total Budget: <span class="text-success fw-bold">$<span
                                    id="grandBudgetTotal">0.00</span></span></h5>
