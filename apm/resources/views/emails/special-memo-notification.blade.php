...
<head>
    ...
    <title>Special Memo Notification - Africa CDC</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>
                @if($type == 'approval')
                    Special Memo Approval Request
                @elseif($type == 'returned')
                    Special Memo Returned for Revision
                @else
                    Special Memo Notification
                @endif
            </h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="details">
                <h2>Special Memo Details</h2>
                <div class="details-grid">
                    <div class="detail-item">
                        <span class="detail-label">Document Number:</span>
                        <span class="detail-value">#{{ $resource->document_number ?? 'N/A' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Activity Title:</span>
                        <span class="detail-value">{{ $resource->activity_title ?? 'N/A' }}</span>
                    </div>
                    <div class="detail-item">
