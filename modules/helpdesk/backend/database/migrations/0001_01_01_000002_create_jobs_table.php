...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists(env('DB_QUEUE_TABLE', 'helpdesk_queue_jobs'));
        Schema::dropIfExists(env('DB_QUEUE_BATCHES_TABLE', 'helpdesk_job_batches'));
        Schema::dropIfExists(env('DB_QUEUE_FAILED_TABLE', 'helpdesk_failed_jobs'));
    }
};
