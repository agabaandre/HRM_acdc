...
@section('header', 'Create New Division')
...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h5 class="mb-0"><i class="bx bx-plus-circle me-2 text-primary"></i>Division Details</h5>
    </div>
    <div class="card-body">
        @if(session('error'))
        ...
        <form action="{{ route('divisions.store') }}" method="POST">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-1"></i> Save Division
                </button>
            </div>
        </form>
    </div>
