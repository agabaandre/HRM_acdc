...
<head>
    <meta charset="utf-8">
    <title>Filtered Staff Task Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <?php endif; ?>
        <small><?= $report_title ?? 'Filtered Staff Task Report' ?></small>
    </div>
    ...
    <table class="tasks-table">
        ...
        <tbody>
            ...
            <?php endforeach; else: ?>
                <tr>
                    <td colspan="6" class="no-tasks">No tasks found matching the applied filters.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
