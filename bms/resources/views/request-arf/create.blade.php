...
@section('title', 'Create ARF Request')

@section('header', 'Create New ARF Request')
...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h5 class="mb-0"><i class="bx bx-file-plus me-2 text-primary"></i>ARF Request Details</h5>
    </div>
    <div class="card-body p-4">
        <form action="{{ route('request-arf.store') }}" method="POST" enctype="multipart/form-data" id="arfRequestForm">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group position-relative">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('arf_number', $arfNumber) }}" 
                               required
                               readonly>
                        @error('arf_number')
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="submit" class="btn btn-primary btn-lg px-5 shadow-sm">
                    <i class="bx bx-save me-2"></i> Create Request
                </button>
            </div>
        </form>
    </div>
