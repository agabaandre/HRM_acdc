...
class PublicScreenApiTest extends TestCase
{
    ...
    public function test_screen_can_scope_volumes_to_a_business_unit(): void
    {
        ...
        $itScreen->assertJsonPath('data.scope.label', 'IT HelpDesk');
        ...
        $hrScreen->assertJsonPath('data.scope.label', 'Human Resource · HelpDesk');
        ...
        $this->assertSame('IT HelpDesk', $labels->get('it-mis'));
        $this->assertSame('Human Resource · HelpDesk', $labels->get('human-resource'));
    }
}
