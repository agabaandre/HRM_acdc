              ...
              <div class="modal fade" id="delete_divisions<?php echo $division->division_id; ?>" tabindex="-1" aria-labelledby="add_item_label" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="add_item_label">Delete Division</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <center>
                            <p><?php echo $division->division_name; ?></p>
                          </center>
                        </div>
