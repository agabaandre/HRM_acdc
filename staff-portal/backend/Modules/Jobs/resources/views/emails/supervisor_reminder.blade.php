  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <a href="{{ $portalBase }}performance/pending_approval" class="btn">View All Assigned PPAs</a>
              ...
              <tbody>
                <?php $i = 1; foreach ($pending_list as $row): ?>
                  <tr>
                    ...
                    <td>
                      <a href="{{ $portalBase }}performance/view_ppa/{{ is_object($row) ? $row->entry_id : $row['entry_id'] }}/{{ is_object($row) ? $row->staff_id : $row['staff_id'] }}" class="btn" style="padding: 6px 12px;">Review</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
