...
@if(!empty($memo) && $memo->request_travel_with_cash)
    @php
        $cashCarrierLabel = TravelCashCarriers::displayNames(TravelCashCarriers::resolveIds($memo));
    @endphp
    <div class="section" style="margin-top: 14px;">
        ...
        <div style="padding: 12px; background: #fff8e6; border: 2px solid #d97706;">
            ...
            <p style="margin: 0 0 8px 0;"><strong>Staff carrying the cash:</strong> {{ $cashCarrierLabel }}</p>
