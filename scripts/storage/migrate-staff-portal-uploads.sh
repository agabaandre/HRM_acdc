...
MODULE="staff-portal"
SRC="${STAFF_PORTAL_LEGACY_ROOT:-${REPO_ROOT}/staff-portal/backend/storage/app/public}"
...
log "Set in staff-portal/backend/.env:"
...
log "Then: cd ${REPO_ROOT}/staff-portal/backend && php artisan storage:link"
