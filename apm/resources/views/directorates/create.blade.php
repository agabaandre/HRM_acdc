...
@section('title', 'Create Directorate')

@section('header', 'Create Directorate')
...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="mb-0"><i class="bx bx-plus-circle me-2"></i>New Directorate</h5>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('directorates.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group position-relative">
                            <label for="name" class="form-label fw-semibold">
                                <i class="bx bx-text me-1 text-primary"></i>Directorate Name <span
                                    class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror"
                                id="name" name="name" value="{{ old('name') }}" placeholder="Enter directorate name"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group position-relative">
                            <label for="code" class="form-label fw-semibold">
                                <i class="bx bx-code me-1 text-primary"></i>Directorate Code <span
                                    class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control form-control-lg @error('code') is-invalid @enderror"
                                id="code" name="code" value="{{ old('code') }}" placeholder="Enter directorate code"
                                required>
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted d-block">Inactive directorates will not be available for selection in other
                        modules</small>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center border-top pt-4 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg px-5 shadow-sm">
                        <i class="bx bx-save me-2"></i> Save Directorate
                    </button>
                </div>
            </form>
        </div>
