...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="container-fluid">
            <div class="py-4">
                ...
                <div class="d-flex gap-2 justify-content-end align-items-center" style="flex-wrap: nowrap !important; white-space: nowrap !important; overflow-x: auto; width: 100%;">
                    ...
                    @if (function_exists('can_copy_memo') && can_copy_memo($specialMemo))
                        <a href="{{ route('special-memo.copy', $specialMemo) }}"
                    ...
                    @elseif($isAdmin && ($specialMemo->overall_status ?? '') === 'archived')
                        <button type="button" class="btn btn-outline-success btn-sm d-flex align-items-center gap-1" data-bs-toggle="modal" data-bs-target="#unarchiveSpecialMemoModal" style="flex-shrink: 0;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="archiveSpecialMemoModalLabel">Archive Special Memo</h5>
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('special-memo.archive', $specialMemo) }}">
                        @csrf
    ...
    <div class="modal fade" id="unarchiveSpecialMemoModal" tabindex="-1" aria-labelledby="unarchiveSpecialMemoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="unarchiveSpecialMemoModalLabel">Unarchive Special Memo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <form method="POST" action="{{ route('special-memo.unarchive', $specialMemo) }}">
                        @csrf
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
               ...
               <div class="col-lg-12">
                ...
                @if(
                    $specialMemo->overall_status === 'draft'
                    && (
                        $specialMemo->staff_id == user_session('staff_id')
                        || ($specialMemo->division && $specialMemo->division->division_head == user_session('staff_id'))
                    )
                )
