...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Endterm Review Status Notification</title>
    <style type="text/css">
      body {
        margin: 0; 
        padding: 0; 
  ...
  <body>
    <div class="container">
      ...
      <!-- Email Content -->
      <div class="content">
        <h1>Endterm Review Status Update</h1>
        <p>Dear <?php echo $name; ?>,</p>
        <p>
          This is to inform you that your <strong>Endterm Review</strong> for the performance period 
        ...
        <p>You can view your Endterm Review and track updates through the HR portal at any time.</p>

        <a href="<?php echo site_url('performance/endterm/endterm_review/' . $entry_id . '/' . $staff_id); ?>" class="btn" style="color:#fff !important;">View My Endterm Review</a>
        ...
        <table class="audit-table">
          ...
          <tbody>
            <?php foreach ($approval_trail as $log): 
              ...
              elseif (!empty($ppa->endterm_supervisor_2) && $log->staff_id == $ppa->endterm_supervisor_2) $role = 'Second Supervisor';
              else $role = 'Other';
            ?>
            <tr>
