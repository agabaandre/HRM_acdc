...
class SettingsApiController extends Controller
{
    ...
    public function hub(): JsonResponse
    {
        ...
        $cards = [
            ...
            ['to' => '/settings/lookup/contracting_institutions', 'label' => 'Contracting Institutions', 'icon' => 'bx-network-chart', 'i18n_key' => 'card_contracting_institutions'],
            ['to' => '/settings/lookup/contract_types', 'label' => 'Contract Types', 'icon' => 'bx-group', 'i18n_key' => 'card_contract_types'],
            ['to' => '/settings/lookup/directorates', 'label' => 'Directorates', 'icon' => 'bx-git-branch', 'i18n_key' => 'card_directorates'],
            ['to' => '/settings/lookup/divisions', 'label' => 'Divisions', 'icon' => 'bx-sitemap', 'special' => true, 'i18n_key' => 'card_divisions'],
            ['to' => '/settings/org-structure', 'label' => 'Organizational structure', 'icon' => 'bx-git-repo-forked', 'special' => true, 'i18n_key' => 'card_org_structure'],
            ['to' => '/settings/lookup/kin_relationship_types', 'label' => 'Next of kin relationships', 'icon' => 'bx-group', 'i18n_key' => 'card_kin'],
            ['to' => '/settings/lookup/grades', 'label' => 'Grades', 'icon' => 'bx-bar-chart-alt-2', 'i18n_key' => 'card_grades'],
            ['to' => '/settings/lookup/jobs', 'label' => 'Jobs', 'icon' => 'bx-briefcase', 'i18n_key' => 'card_jobs'],
            ['to' => '/settings/lookup/funders', 'label' => 'Funders', 'icon' => 'bx-dollar', 'i18n_key' => 'card_funders'],
            ['to' => '/settings/leave', 'label' => 'Leave policy, types & holidays', 'icon' => 'bx-time-five', 'i18n_key' => 'card_leave'],
            ['to' => '/leave/admin/balances', 'label' => 'Leave balances (all staff)', 'icon' => 'bx-calendar-check', 'i18n_key' => 'card_leave_balances'],
            ['to' => '/settings/performance', 'label' => 'PPA / workflow', 'icon' => 'bx-line-chart', 'i18n_key' => 'card_ppa'],
            ['to' => '/settings/lookup/regions', 'label' => 'Regions', 'icon' => 'bx-compass', 'i18n_key' => 'card_regions'],
            ['to' => '/settings/lookup/units', 'label' => 'Units', 'icon' => 'bx-building', 'i18n_key' => 'card_units'],
            ['to' => '/settings/lookup/training_skills', 'label' => 'Training Skills', 'icon' => 'bx-book', 'i18n_key' => 'card_training_skills'],
            ['to' => '/settings/lookup/au_values', 'label' => 'AU Values', 'icon' => 'bx-star', 'i18n_key' => 'card_au_values'],
        ];
