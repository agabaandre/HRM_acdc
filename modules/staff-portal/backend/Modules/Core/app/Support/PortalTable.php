...
class PortalTable
{
    ...
    public static function paginateDistinct(
        ...
        return new LengthAwarePaginator(
            ...
            $perPage,
            $page,
            self::paginationOptions($pageName)
        );
    }

    /**
     * @return array{path: string, pageName: string, query: array<string, mixed>}
     */
    public static function paginationOptions(string $pageName = 'page'): array
    {
        return [
            'path' => request()->url(),
            'pageName' => $pageName,
