...
use App\Http\Controllers\Concerns\ChangeRequestListIndexResponses;
...
class ChangeRequestController extends Controller
{
    ...
    use ChangeRequestListIndexResponses;
    ...
    public function index(Request $request): View|JsonResponse
    {
        if (\App\Support\ApmListFragment::wants($request)) {
            return $this->getChangeRequestsIndexAjax($request);
        }

        return view('change-requests.index', [
            'pageConfig' => $this->buildChangeRequestsIndexPageConfig($request),
        ]);
    }
