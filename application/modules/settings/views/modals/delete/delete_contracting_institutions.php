              ...
              <div class="modal fade" id="delete_institution<?php echo $institute->contracting_institution_id; ?>" tabindex="-1" aria-labelledby="add_item_label" aria-hidden="true">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <center>
                            <p><?php echo $institute->contracting_institution; ?></p>
                          </center>
                        </div>
