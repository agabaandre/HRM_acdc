  ...
  <?php
    ...
    if (!function_exists('getLatestApprovalForOrder')) {
        function getLatestApprovalForOrder($approvalTrails, $order) {
            return \App\Helpers\PrintHelper::getLatestApprovalForOrder($approvalTrails, $order);
        }
    }
 ...
 <table class="mb-15 mt-neg20">
  ...
  <div>
    ...
    <div class="page-break"></div>
     ...
     $_approvalSm = $specialMemo->activity_request_remarks ?? $specialMemo->justification ?? '';
     echo \App\Helpers\PrintHelper::sanitizeRichTextForMpdf($_approvalSm !== '' ? $_approvalSm : 'N/A');
     ?></div>
