...
Route::resource('fund-types', App\Http\Controllers\FundTypeController::class)->except(['destroy']);
    ...
    Route::get('weekly-briefing/{report}/director-review-modal', [App\Http\Controllers\WeeklyBriefingController::class, 'directorReviewModal'])->name('weekly-briefing.director-review-modal');
